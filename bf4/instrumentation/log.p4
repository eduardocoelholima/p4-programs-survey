...
@controlled extern void query_schedule_table_0(@matchKind("exact") in bit<32> schedule_table_0_ipv4_dstAddr, @matchKind("range") in bit<32> schedule_table_0_rtp_timestamp, out bool __ret___hit, out bool __ret___reach, out flow_def_schedule_table_0__action_type_t __ret___action_run, out bit<32> __ret___take_video_0__dst_ip, out bit<32> __ret___key_schedule_table_0_ipv4_dstAddr, out bit<32> __ret___key_schedule_table_0_rtp_timestamp__min, out bit<32> __ret___key_schedule_table_0_rtp_timestamp__max);
...
parser ParserImpl(@mutable_packet() inout packet_model packet_ParserImpl, out headers hdr_ParserImpl, inout metadata meta_ParserImpl, inout standard_metadata_t standard_metadata_ParserImpl, inout error err_ParserImpl) {
    state parse_ipv4 {
        ...
        transition select(hdr_ParserImpl.ipv4.protocol) {
            8w0x11: parse_udp;
            default: accept;
        }
    }
    state parse_udp {
        hdr_ParserImpl.udp.valid_ = true;
        {
            modelPop<bit<16>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.udp.srcPort);
        }
        {
            modelPop<bit<16>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.udp.dstPort);
        }
        {
            modelPop<bit<16>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.udp.hdr_length);
        }
        {
            modelPop<bit<16>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.udp.checksum);
        }
        hdr_ParserImpl.rtp.valid_ = true;
        {
            modelPop<bit<2>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.version);
        }
        {
            modelPop<bit<1>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.padding);
        }
        {
            modelPop<bit<1>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.extension);
        }
        {
            modelPop<bit<4>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.CSRC_count);
        }
        {
            modelPop<bit<1>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.marker);
        }
        {
            modelPop<bit<7>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.payload_type);
        }
        {
            modelPop<bit<16>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.sequence_number);
        }
        {
            modelPop<bit<32>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.timestamp);
        }
        {
            modelPop<bit<32>>(packet_ParserImpl, packet_ParserImpl, hdr_ParserImpl.rtp.SSRC);
        }
        transition accept;
    }
    state start {
        ...
        hdr_ParserImpl.rtp.valid_ = false;
        hdr_ParserImpl.udp.valid_ = false;
...
control ingress(inout headers hdr_ingress, inout metadata meta_ingress, inout standard_metadata_t standard_metadata_ingress) {
    ...
    flow_def_schedule_table_0 schedule_table_0_ingress;
    flow_def_schedule_table_0 tmp_ingress;
    @name("ingress.my_direct_counter") direct_counter(CounterType.bytes) my_direct_counter;
    apply {
        __track_egress_spec_ingress = false;
        query_schedule_table_0(hdr_ingress.ipv4.dstAddr, hdr_ingress.rtp.timestamp, tmp_ingress.hit, tmp_ingress.reach, tmp_ingress.action_run, tmp_ingress.take_video_0__dst_ip, tmp_ingress.key_schedule_table_0_ipv4_dstAddr, tmp_ingress.key_schedule_table_0_rtp_timestamp__min, tmp_ingress.key_schedule_table_0_rtp_timestamp__max);
        {
            schedule_table_0_ingress.hit = tmp_ingress.hit;
            schedule_table_0_ingress.reach = tmp_ingress.reach;
            schedule_table_0_ingress.action_run = tmp_ingress.action_run;
            schedule_table_0_ingress.take_video_0__dst_ip = tmp_ingress.take_video_0__dst_ip;
            schedule_table_0_ingress.key_schedule_table_0_ipv4_dstAddr = tmp_ingress.key_schedule_table_0_ipv4_dstAddr;
            schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__min = tmp_ingress.key_schedule_table_0_rtp_timestamp__min;
            schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__max = tmp_ingress.key_schedule_table_0_rtp_timestamp__max;
        }
        if (schedule_table_0_ingress.hit) {
            key_match(hdr_ingress.ipv4.dstAddr == schedule_table_0_ingress.key_schedule_table_0_ipv4_dstAddr && (hdr_ingress.rtp.timestamp <= schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__max && hdr_ingress.rtp.timestamp >= schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__min));
            if (!hdr_ingress.ipv4.valid_) {
                bug();
            }
            if (!(hdr_ingress.rtp.valid_ && hdr_ingress.rtp.valid_ || hdr_ingress.rtp.valid_ && hdr_ingress.rtp.timestamp > schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__max || hdr_ingress.rtp.valid_ && hdr_ingress.rtp.timestamp < schedule_table_0_ingress.key_schedule_table_0_rtp_timestamp__min)) {
                bug();
            }
        }
        if (schedule_table_0_ingress.action_run == flow_def_schedule_table_0__action_type_t.NoAction_0) {
            ;
        }
        else {
            if (schedule_table_0_ingress.action_run == flow_def_schedule_table_0__action_type_t._drop_0) {
                angelic_assert(true);
                my_direct_counter.count();
                standard_metadata_ingress.egress_spec = 9w511;
                __track_egress_spec_ingress = true;
            }
            else {
                if (schedule_table_0_ingress.action_run == flow_def_schedule_table_0__action_type_t.take_video_0) {
                    angelic_assert(true);
                    my_direct_counter.count();
                    standard_metadata_ingress.egress_spec = 9w1;
                    __track_egress_spec_ingress = true;
                    if (hdr_ingress.ipv4.valid_) {
                        hdr_ingress.ipv4.dstAddr = schedule_table_0_ingress.take_video_0__dst_ip;
                    }
                    else {
                        bug();
                    }
...
control DeparserImpl(@mutable_packet() inout packet_model packet_DeparserImpl, in headers hdr_DeparserImpl) {
    apply {
        ...
        if (hdr_DeparserImpl.udp.valid_) {
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.udp.srcPort);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.udp.dstPort);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.udp.hdr_length);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.udp.checksum);
        }
        if (hdr_DeparserImpl.rtp.valid_) {
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.version);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.padding);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.extension);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.CSRC_count);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.marker);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.payload_type);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.sequence_number);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.timestamp);
            modelEmit(packet_DeparserImpl, packet_DeparserImpl, hdr_DeparserImpl.rtp.SSRC);
        }
    }
}
...
void PSAImpl_egress_start_(@mutable_packet() inout packet_model p_PSAImpl_egress_start, inout headers hdrs__PSAImpl_egress_start, inout metadata metas__PSAImpl_egress_start, inout standard_metadata_t standard_meta_PSAImpl_egress_start) {
    ...
    }
    {
        ...
        clone_hdrs_PSAImpl_egress_start.rtp.version = hdrs__PSAImpl_egress_start.rtp.version;
        clone_hdrs_PSAImpl_egress_start.rtp.padding = hdrs__PSAImpl_egress_start.rtp.padding;
        clone_hdrs_PSAImpl_egress_start.rtp.extension = hdrs__PSAImpl_egress_start.rtp.extension;
        clone_hdrs_PSAImpl_egress_start.rtp.CSRC_count = hdrs__PSAImpl_egress_start.rtp.CSRC_count;
        clone_hdrs_PSAImpl_egress_start.rtp.marker = hdrs__PSAImpl_egress_start.rtp.marker;
        clone_hdrs_PSAImpl_egress_start.rtp.payload_type = hdrs__PSAImpl_egress_start.rtp.payload_type;
        clone_hdrs_PSAImpl_egress_start.rtp.sequence_number = hdrs__PSAImpl_egress_start.rtp.sequence_number;
        clone_hdrs_PSAImpl_egress_start.rtp.timestamp = hdrs__PSAImpl_egress_start.rtp.timestamp;
        clone_hdrs_PSAImpl_egress_start.rtp.SSRC = hdrs__PSAImpl_egress_start.rtp.SSRC;
        clone_hdrs_PSAImpl_egress_start.rtp.valid_ = hdrs__PSAImpl_egress_start.rtp.valid_;
        clone_hdrs_PSAImpl_egress_start.udp.srcPort = hdrs__PSAImpl_egress_start.udp.srcPort;
        clone_hdrs_PSAImpl_egress_start.udp.dstPort = hdrs__PSAImpl_egress_start.udp.dstPort;
        clone_hdrs_PSAImpl_egress_start.udp.hdr_length = hdrs__PSAImpl_egress_start.udp.hdr_length;
        clone_hdrs_PSAImpl_egress_start.udp.checksum = hdrs__PSAImpl_egress_start.udp.checksum;
        clone_hdrs_PSAImpl_egress_start.udp.valid_ = hdrs__PSAImpl_egress_start.udp.valid_;
    }
    {
    }
...
void PSAImpl_ingress_start_(@mutable_packet() inout packet_model p_PSAImpl_ingress_start, inout headers hdrs__PSAImpl_ingress_start, inout metadata metas__PSAImpl_ingress_start, inout standard_metadata_t standard_meta_PSAImpl_ingress_start) {
    ...
    }
    {
        ...
        clone_hdrs_2_PSAImpl_ingress_start.rtp.version = hdrs__PSAImpl_ingress_start.rtp.version;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.padding = hdrs__PSAImpl_ingress_start.rtp.padding;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.extension = hdrs__PSAImpl_ingress_start.rtp.extension;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.CSRC_count = hdrs__PSAImpl_ingress_start.rtp.CSRC_count;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.marker = hdrs__PSAImpl_ingress_start.rtp.marker;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.payload_type = hdrs__PSAImpl_ingress_start.rtp.payload_type;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.sequence_number = hdrs__PSAImpl_ingress_start.rtp.sequence_number;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.timestamp = hdrs__PSAImpl_ingress_start.rtp.timestamp;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.SSRC = hdrs__PSAImpl_ingress_start.rtp.SSRC;
        clone_hdrs_2_PSAImpl_ingress_start.rtp.valid_ = hdrs__PSAImpl_ingress_start.rtp.valid_;
        clone_hdrs_2_PSAImpl_ingress_start.udp.srcPort = hdrs__PSAImpl_ingress_start.udp.srcPort;
        clone_hdrs_2_PSAImpl_ingress_start.udp.dstPort = hdrs__PSAImpl_ingress_start.udp.dstPort;
        clone_hdrs_2_PSAImpl_ingress_start.udp.hdr_length = hdrs__PSAImpl_ingress_start.udp.hdr_length;
        clone_hdrs_2_PSAImpl_ingress_start.udp.checksum = hdrs__PSAImpl_ingress_start.udp.checksum;
        clone_hdrs_2_PSAImpl_ingress_start.udp.valid_ = hdrs__PSAImpl_ingress_start.udp.valid_;
    }
    {
    }
...
void parse_and_run_(@mutable_packet() inout packet_model pin_parse_and_run, inout metadata metas__parse_and_run, inout standard_metadata_t standard_meta_parse_and_run) {
    ...
    now(standard_meta_parse_and_run.ingress_global_timestamp);
    {
        ...
        hdrs_0_parse_and_run.rtp.valid_ = false;
        hdrs_0_parse_and_run.udp.valid_ = false;
    }
    ParserImpl() p;
    ;
