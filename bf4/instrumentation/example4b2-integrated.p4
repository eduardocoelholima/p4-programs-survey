...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_t3_0 tmp_2;
    apply {
        tmp_1 = query_t2_0(hdr.ethernet.etherType);
        t2 = tmp_1;
        if (t2.hit) {
        ...
        if (t2.action_run == flow_def_t2_0__action_type_t.NoAction_0) {
            ;
        }
        else {
            if (t2.action_run == flow_def_t2_0__action_type_t._drop) {
                angelic_assert(true);
            }
            else {
        ...
        end_t2_0();
        tmp_2 = query_t3_0(hdr.ethernet.etherType);
        t3 = tmp_2;
        if (t3.hit) {
        ...
        if (t3.action_run == flow_def_t3_0__action_type_t.NoAction_3) {
            ;
        }
        else {
            if (t3.action_run == flow_def_t3_0__action_type_t._drop_2) {
                angelic_assert(true);
            }
            else {
