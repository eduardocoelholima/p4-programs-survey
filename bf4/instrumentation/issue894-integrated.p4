...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_send_frame_0 tmp_4;
    apply {
        tmp_4 = query_send_frame_0(standard_metadata.egress_port);
        send_frame = tmp_4;
        if (send_frame.hit) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_set_heavy_hitter_count_table_0 tmp_5;
    flow_def_drop_heavy_hitter_table_0 tmp_6;
    flow_def_ipv4_lpm_0 tmp_7;
    flow_def_forward_0 tmp_8;
    apply {
        __track_egress_spec_0 = false;
        tmp_5 = query_set_heavy_hitter_count_table_0();
        set_heavy_hitter_count_table = tmp_5;
        ...
        if (meta._custom_metadata_count_val13 > 16w100 && meta._custom_metadata_count_val24 > 16w100) {
            tmp_6 = query_drop_heavy_hitter_table_0();
            drop_heavy_hitter_table = tmp_6;
    ...
    if (recirculate_flag_0 != 32w0) {
        {
            ...
            clone_metas_0._custom_metadata_hash_val11 = 16w0;
            clone_metas_0._custom_metadata_hash_val22 = 16w0;
            clone_metas_0._custom_metadata_count_val13 = 16w0;
            clone_metas_0._custom_metadata_count_val24 = 16w0;
        }
...
void run() {
    ...
    standard_meta_0.ingress_global_timestamp = now();
    {
        ...
        metas._custom_metadata_hash_val11 = 16w0;
        metas._custom_metadata_hash_val22 = 16w0;
        metas._custom_metadata_count_val13 = 16w0;
        metas._custom_metadata_count_val24 = 16w0;
    }
