...
parser ParserImpl(mutable_packet packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata, inout error err) {
    ...
    @name(".start") state start {
        ...
        tmp_8 = packet.lookahead<bit<64>>();
        tmp_7 = tmp_8;
        tmp_6 = tmp_7;
        tmp_5 = tmp_6;
        transition select(tmp_5[63:0]) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_nat_0 nat;
    flow_def_ipv4_lpm_0 tmp_9;
    flow_def_nat_0 tmp_10;
    apply {
        standard_metadata.egress_spec = 9w511;
        __track_egress_spec_0 = true;
        tmp_9 = query_ipv4_lpm_0(hdr.ipv4.dstAddr);
        ipv4_lpm = tmp_9;
        if (ipv4_lpm.hit) {
        ...
        end_ipv4_lpm_0();
        tmp_10 = query_nat_0(hdr.ipv4.isValid(), hdr.ipv4.srcAddr);
        nat = tmp_10;
        if (nat.hit) {
