...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_nat_table_0 tmp_1;
    apply {
        tmp_1 = query_nat_table_0(meta._intrinsic_metadata_egress_rid2, hdr.ipv4.dstAddr);
        nat_table = tmp_1;
        if (nat_table.hit) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_set_mcg_0 tmp_2;
    apply {
        __track_egress_spec_0 = false;
        tmp_2 = query_set_mcg_0(hdr.ipv4.dstAddr);
        set_mcg = tmp_2;
        if (set_mcg.hit) {
...
void PSAImpl_egress_start_(mutable_packet p, inout headers hdrs_, inout metadata metas_, inout standard_metadata_t standard_meta) {
    ...
    if (recirculate_flag_0 != 32w0) {
        {
            clone_metas_0._intrinsic_metadata_mcast_grp0 = 16w0;
            clone_metas_0._intrinsic_metadata_lf_field_list1 = 32w0;
            clone_metas_0._intrinsic_metadata_egress_rid2 = 16w0;
            clone_metas_0._intrinsic_metadata_ingress_global_timestamp3 = 32w0;
        }
...
void run() {
    ...
    {
        metas._intrinsic_metadata_mcast_grp0 = 16w0;
        metas._intrinsic_metadata_lf_field_list1 = 32w0;
        metas._intrinsic_metadata_egress_rid2 = 16w0;
        metas._intrinsic_metadata_ingress_global_timestamp3 = 32w0;
    }
