...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_send_frame_0 tmp_3;
    apply {
        tmp_3 = query_send_frame_0(standard_metadata.egress_port);
        send_frame = tmp_3;
        if (send_frame.hit) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    flow_def_count_table_0 tmp_4;
    flow_def_ipv4_lpm_0 tmp_5;
    flow_def_forward_0 tmp_6;
    @name("ingress.ip_src_counter") counter(32w1024, CounterType.packets) ip_src_counter_0;
    apply {
        __track_egress_spec_0 = false;
        tmp_4 = query_count_table_0(hdr.ipv4.srcAddr);
        count_table = tmp_4;
        if (count_table.hit) {
        ...
        end_count_table_0();
        tmp_5 = query_ipv4_lpm_0(hdr.ipv4.dstAddr);
        ipv4_lpm = tmp_5;
        if (ipv4_lpm.hit) {
        ...
        end_ipv4_lpm_0();
        tmp_6 = query_forward_0(meta._custom_metadata_nhop_ipv40);
        forward = tmp_6;
        if (forward.hit) {
