...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".drop_heavy_hitter_table") @instrument_keys() table drop_heavy_hitter_table {
        actions = {
            _drop_2();
    ...
    @name(".set_heavy_hitter_count_table") @instrument_keys() table set_heavy_hitter_count_table {
        actions = {
